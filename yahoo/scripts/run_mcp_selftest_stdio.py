...
CMD = "/Users/yordamkocatepe/mcp/scripts/mcp-yahoo-stdio.sh"
...
async def run_tests() -> int:
    ...
    params = StdioServerParameters(command=CMD, args=[], env={"PYTHONPATH": "/Users/yordamkocatepe/mcp/yahoo/libs/py/mcp_yahoo/src", "MCP_TRANSPORT": "stdio"})
